...
public class SubmitAccountPage {
	...
	public static final Target STATE = Target.the("state").locatedBy("//*[@id='select-FormField_12']/option[@value='{0}']");
	public static final Target COUNTRY = Target.the("country").locatedBy("//*[@id=\"select-FormField_11\"]/option[@value='{0}']");
	...
	public static final Target VALIDATE= Target.the("validate").located(By.xpath("/html/body/div[2]/main/div/article/section/div/div[2]/div/div"));
}
